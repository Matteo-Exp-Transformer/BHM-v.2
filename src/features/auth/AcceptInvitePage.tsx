...
const AcceptInvitePage: React.FC = () => {
  ...
  // Disabilita validazione se invito è già stato accettato
  const { data: validation, isLoading: isValidating } = useValidateInvite(inviteAccepted ? null : token)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    acceptInvite(
      ...
      {
        onSuccess: () => {
          setInviteAccepted(true) // Disabilita validazione futura
  ...
  // Se non c'è invite (dopo accettazione), mostra successo
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50 py-12 px-4">
        <div className="w-full max-w-md">
          <div className="bg-white shadow-2xl rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Il tuo account è stato creato con successo.</p>
  ...
  // Se non c'è invite e non è stato accettato, errore
  if (!invite) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-white to-orange-50 py-12 px-4">
        <div className="w-full max-w-md">
          <div className="bg-white shadow-2xl rounded-2xl p-8 text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Link Invito Non Valido</h1>
            <p className="text-gray-600 mb-6">
              Il link di invito non è valido o è scaduto.
            </p>
            <div className="bg-gray-50 rounded-lg p-4 mb-6 text-left">
              <p className="text-sm text-gray-700 mb-2"><strong>Cosa fare:</strong></p>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• Contatta il tuo amministratore</li>
                <li>• Verifica che il link sia corretto</li>
                <li>• Richiedi un nuovo invito</li>
              </ul>
            </div>
            <Link
              to="/sign-in"
