...
-- Products (prodotti in inventario) - RIMOSSO TEMPORANEAMENTE PER ORDINE CREAZIONE
...
-- Products (prodotti in inventario) - AGGIUNTO DOPO CONSERVATION_POINTS
...
WHERE table_schema = 'public' 
  AND table_name IN (
    ...
    'product_categories', 'conservation_points', 'temperature_readings', 'products',
