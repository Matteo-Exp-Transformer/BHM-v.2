...
-- ============================================================================
--
-- VERSIONE CORRETTA - Usa schema public invece di auth
--
-- ============================================================================
...
USING (
  shopping_list_id IN (
    SELECT id FROM shopping_lists WHERE company_id = public.get_user_company_id()
  )
);
...
-- ============================================================================
-- FINE SCRIPT RLS POLICIES - VERSIONE CORRETTA
-- ============================================================================
