import { r as y } from './react-vendor-Cttizgra.js'
var ut = { exports: {} },
  K = {}
/**
 * @license React
...
function ht(t, e, s) {
  ...
  for (i in e) Pt.call(e, i) && !Et.hasOwnProperty(i) && (r[i] = e[i])
  if (t && t.defaultProps)
    for (i in ((e = t.defaultProps), e)) r[i] === void 0 && (r[i] = e[i])
  return { $$typeof: wt, type: t, key: a, ref: o, props: r, _owner: Ft.current }
}
K.Fragment = Rt
K.jsx = ht
K.jsxs = ht
...
function Z(t, e) {
  ...
  if (o) {
    ...
    } else if (!A(e.queryKey, o)) return !1
  }
  if (s !== 'all') {
    const u = e.isActive()
...
function X(t, e) {
  ...
  if (a) {
    ...
    if (s) {
      if (I(e.options.mutationKey) !== I(a)) return !1
    } else if (!A(e.options.mutationKey, a)) return !1
  }
  ...
  return t === e
    ...
    : typeof t != typeof e
      ...
      : t && e && typeof t == 'object' && typeof e == 'object'
        ? Object.keys(e).every(s => A(t[s], e[s]))
        : !1
}
...
function yt(t) {
  ...
  const r = B(),
    ...
    f = () =>
      J.isFocused() &&
      (t.networkMode === 'always' || k.isOnline()) &&
      t.canRun(),
    h = () => pt(t.networkMode) && t.canRun(),
    m = l => {
      a() || (i?.(), r.resolve(l))
    },
    c = l => {
      ...
      Promise.resolve(l)
        ...
        .catch(g => {
          ...
          const w = t.retry ?? (T ? 0 : 3),
            P = t.retryDelay ?? Lt,
            E = typeof P == 'function' ? P(s, g) : P,
            M =
              w === !0 ||
              (typeof w == 'number' && s < w) ||
              (typeof w == 'function' && w(s, g))
          if (e || !M) {
            c(g)
            return
          }
...
var mt = class {
    ...
    updateGcTime(t) {
      this.gcTime = Math.max(this.gcTime || 0, t ?? (T ? 1 / 0 : 5 * 60 * 1e3))
    }
    clearGcTimeout() {
...
var Ht = class extends D {
  ...
  onSubscribe() {
    this.listeners.size === 1 &&
      ...
      it(this.#e, this.options) ? this.#l() : this.updateResult(),
      this.#g())
  }
  onUnsubscribe() {
  ...
  setOptions(t) {
    ...
    ;(i && rt(this.#e, s, this.options, e) && this.#l(),
      this.updateResult(),
      i &&
        (this.#e !== s ||
  ...
  #m() {
    ...
    if (T || this.#r.isStale || !N(t)) return
    const s = ct(this.#r.dataUpdatedAt, t) + 1
    this.#h = Q.setTimeout(() => {
  ...
  createResult(t, e) {
    ...
    if (e._optimisticResults) {
      const O = this.hasListeners(),
        U = !O && it(t, e),
        x = O && rt(t, s, e, i)
      ;((U || x) && (h = { ...h, ...vt(f.data, t.options) }),
        e._optimisticResults === 'isRestoring' && (h.fetchStatus = 'idle'))
    }
    let { error: C, errorUpdatedAt: p, status: l } = h
    c = h.data
    let v = !1
      ...
      ;(r?.isPlaceholderData && e.placeholderData === o?.placeholderData
        ...
        : (O =
            typeof e.placeholderData == 'function'
              ...
              : e.placeholderData),
        O !== void 0 && ((l = 'success'), (c = G(r?.data, O, e)), (m = !0)))
    }
    ...
    this.#n && ((C = this.#n), (c = this.#f), (p = Date.now()), (l = 'error'))
    ...
    if (this.options.experimental_prefetchInRender) {
      const O = q => {
          R.status === 'error'
            ? q.reject(R.error)
            : R.data !== void 0 && q.resolve(R.data)
        },
        U = () => {
          const q = (this.#o = R.promise = B())
          O(q)
        },
        x = this.#o
      switch (x.status) {
        case 'pending':
          t.queryHash === s.queryHash && O(x)
          break
        case 'fulfilled':
          ;(R.status === 'error' || R.data !== x.value) && U()
          break
        case 'rejected':
          ;(R.status !== 'error' || R.error !== x.reason) && U()
          break
      }
    }
    return R
...
function it(t, e) {
  return Gt(t, e) || (t.state.data !== void 0 && W(t, e, e.refetchOnMount))
}
function W(t, e, s) {
  if (S(e.enabled, t) !== !1 && F(e.staleTime, t) !== 'static') {
    const i = typeof s == 'function' ? s(t) : s
    return i === 'always' || (i !== !1 && Y(t, e))
  }
  return !1
}
function rt(t, e, s, i) {
      ...
      const f = async () => {
        ...
        const m = p => {
          ...
          C = async (p, l, v) => {
            ...
            return {
              pages: M(p.pages, P, E),
              pageParams: M(p.pageParams, l, E),
            }
          }
        if (r && a.length) {
          const p = r === 'backward',
            l = p ? zt : at,
            v = { pages: a, pageParams: o },
            g = l(i, v)
          n = await C(v, g, p)
        } else {
          const p = t ?? a.length
          do {
            const l = u === 0 ? (o[0] ?? i.initialPageParam) : at(i, n)
            if (u > 0 && l == null) break
            ;((n = await C(n, l)), u++)
          } while (u < p)
        }
...
var $t = class extends D {
  ...
  resumePausedMutations() {
    ...
    return d.batch(() => Promise.all(t.map(e => e.continue().catch(b))))
  }
}
function j(t) {
...
var Vt = class extends D {
    ...
    setOptions(t) {
      ...
      ;((this.options = this.#t.defaultMutationOptions(t)),
        ...
        I(e.mutationKey) !== I(this.options.mutationKey)
          ? this.reset()
  ...
  Jt = class extends D {
    ...
    find(t) {
      const e = { exact: !0, ...t }
      return this.getAll().find(s => Z(e, s))
    }
    findAll(t = {}) {
      const e = this.getAll()
      return Object.keys(t).length > 0 ? e.filter(s => Z(t, s)) : e
    }
    notify(t) {
      d.batch(() => {
        this.listeners.forEach(e => {
  ...
  he = class {
    ...
    #n
    constructor(t = {}) {
      ;((this.#t = t.queryCache || new Jt()),
        (this.#e = t.mutationCache || new $t()),
    ...
    fetchInfiniteQuery(t) {
      return ((t.behavior = nt(t.pages)), this.fetchQuery(t))
    }
    prefetchInfiniteQuery(t) {
      return this.fetchInfiniteQuery(t).then(b).catch(b)
    }
    ensureInfiniteQueryData(t) {
      return ((t.behavior = nt(t.pages)), this.ensureQueryData(t))
    }
    resumePausedMutations() {
    ...
    setQueryDefaults(t, e) {
      this.#r.set(I(t), { queryKey: t, defaultOptions: e })
    }
    getQueryDefaults(t) {
    ...
    setMutationDefaults(t, e) {
      this.#i.set(I(t), { mutationKey: t, defaultOptions: e })
    }
  ...
  gt = y.createContext(void 0),
  Ot = t => {
    const e = y.useContext(gt)
    if (!e)
  ...
  ce = ({ client: t, children: e }) => (
    ...
    Mt.jsx(gt.Provider, { value: t, children: e })
  ),
...
var Xt = y.createContext(Zt()),
  ...
  ie = ({
    ...
    !t.isFetching &&
    i &&
    ((r && t.data === void 0) || dt(s, [t.error, i])),
  re = t => {
    if (t.suspense) {
...
function oe(t, e, s) {
  ...
  if (
    (y.useSyncExternalStore(
      y.useCallback(
        m => {
          const c = h ? u.subscribe(d.batchCalls(m)) : b
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !T &&
      ne(f, i) &&
      (n ? ot(o, u, r) : a.getQueryCache().get(o.queryHash)?.promise)
        ?.catch(b)
        .finally(() => {
          u.updateResult()
        }),
...
function fe(t, e) {
  const s = Ot(),
    [i] = y.useState(() => new Vt(s, t))
  y.useEffect(() => {
    i.setOptions(t)
  }, [i, t])
  const r = y.useSyncExternalStore(
      y.useCallback(o => i.subscribe(d.batchCalls(o)), [i]),
      () => i.getCurrentResult(),
      () => i.getCurrentResult()
    ),
    a = y.useCallback(
  ...
  if (r.error && dt(i.options.throwOnError, [r.error])) throw r.error
  return { ...r, mutate: a, mutateAsync: r.mutate }
}
export { he as Q, Ot as a, fe as b, ce as c, Mt as j, le as u }
