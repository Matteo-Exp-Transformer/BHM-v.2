import { r as Lt, a as Ut, b as jt } from './react-vendor-Cttizgra.js'
var ht,
  S,
  jr,
  zr,
...
function Hs(t, e, n, r, i) {
  var s
  for (s in n)
    s === 'children' || s === 'key' || s in e || Je(t, s, null, n[s], r)
  for (s in e)
...
function Un(t, e, n) {
  e[0] === '-'
    ? t.setProperty(e, n ?? '')
    : (t[e] =
        n == null ? '' : typeof n != 'number' || Ps.test(e) ? n : n + 'px')
}
  ...
  e: if (e === 'style')
    if (typeof n == 'string') t.style.cssText = n
      ...
      if ((typeof r == 'string' && (t.style.cssText = r = ''), r))
        for (e in r) (n && e in n) || Un(t.style, e, '')
      if (n) for (e in n) (r && n[e] === r[e]) || Un(t.style, e, n[e])
    }
  else if (e[0] === 'o' && e[1] === 'n')
    ((s = e !== (e = e.replace(/Capture$/, ''))),
      ...
      (t.l[e + s] = n),
      n
        ? r || t.addEventListener(e, s ? zn : jn, s)
        : t.removeEventListener(e, s ? zn : jn, s))
...
function zt(t) {
  ;((!t.__d && (t.__d = !0) && ce.push(t) && !Ke.__r++) ||
    Ln !== S.debounceRendering) &&
    ((Ln = S.debounceRendering) || Bs)(Ke)
}
function Ke() {
  var t, e, n, r, i, s, l, o
  for (
    ce.sort(function (a, d) {
...
function Qr(t, e, n, r, i, s, l, o, a, d) {
  ...
  for (n.__k = [], c = 0; c < e.length; c++)
    if (
      (u = n.__k[c] =
        (u = e[c]) == null || typeof u == 'boolean'
          ...
          : typeof u == 'string' || typeof u == 'number' || typeof u == 'bigint'
            ? Ge(null, u, null, null, u)
            : Array.isArray(u)
              ? Ge(x, { children: u }, null, null, null)
              : u.__b > 0
                ? Ge(u.type, u.props, u.key, u.ref ? u.ref : null, u.__v)
                : u) != null
    ) {
      if (
        ((u.__ = n),
      ...
      ;(nn(t, u, (f = f || Xe), i, s, l, o, a, d),
        (m = u.__e),
        (h = u.ref) &&
          f.ref != h &&
          (b || (b = []),
          f.ref && b.push(f.ref, null, u),
          b.push(h, u.__c || m, u)),
        m != null
          ? (v == null && (v = m),
          ...
          : a && f.__e == a && a.parentNode != t && (a = ke(f)))
    }
  for (n.__e = v, c = E; c--; )
    y[c] != null &&
      ...
      Kr(y[c], y[c]))
  if (b) for (c = 0; c < b.length; c++) Jr(b[c], b[++c], b[++c])
}
function Yr(t, e, n) {
  for (var r, i = t.__k, s = 0; i && s < i.length; s++)
    (r = i[s]) &&
      ((r.__ = t),
      (e =
        typeof r.type == 'function' ? Yr(r, e, n) : Zr(n, r, r, i, r.__e, e)))
  return e
}
function et(t, e) {
  return (
...
function nn(t, e, n, r, i, s, l, o, a) {
  ...
  ;(n.__h != null &&
    ((a = n.__h), (o = e.__e = n.__e), (e.__h = null), (s = [o])),
    (d = S.__b) && d(e))
  try {
    e: if (typeof R == 'function') {
      if (
        ((b = e.props),
        (y = (d = R.contextType) && r[d.__c]),
        ...
        R.getDerivedStateFromProps != null &&
          ...
          K(c.__s, R.getDerivedStateFromProps(b, c.__s))),
        (f = c.props),
        (u = c.state),
        (c.__v = e),
        h)
        ...
        if (
          (R.getDerivedStateFromProps == null &&
            ...
            c.componentWillReceiveProps(b, E),
          (!c.__e &&
            c.shouldComponentUpdate != null &&
            c.shouldComponentUpdate(b, c.__s, E) === !1) ||
            e.__v === n.__v)
        ) {
          for (
            e.__v !== n.__v && ((c.props = b), (c.state = c.__s), (c.__d = !1)),
              e.__e = n.__e,
              e.__k = n.__k,
              e.__k.forEach(function (J) {
                J && (J.__ = e)
              }),
              D = 0;
            D < c._sb.length;
      ...
      if (
        ...
        while (c.__d && ++O < 25)
      ;((c.state = c.__s),
        c.getChildContext != null && (r = K(K({}, r), c.getChildContext())),
        h ||
          c.getSnapshotBeforeUpdate == null ||
          (m = c.getSnapshotBeforeUpdate(f, u)),
        (I = d != null && d.type === x && d.key == null ? d.props.children : d),
        Qr(t, Array.isArray(I) ? I : [I], e, n, r, i, s, l, o, a),
        (c.base = e.__e),
        (e.__h = null),
...
function Ls(t, e, n, r, i, s, l, o) {
  ...
  if (u === null) h === f || (o && t.data === f) || (t.data = f)
    ...
    if (
      ((s = s && ht.call(t.childNodes)),
      (d = (h = n.props || Xe).dangerouslySetInnerHTML),
    ...
    if ((Hs(t, f, h, i, o), c)) e.__k = []
      ...
      for (m = s.length; m--; ) s[m] != null && Gr(s[m])
    o ||
      ('value' in f &&
        (m = f.value) !== void 0 &&
        (m !== t.value ||
...
function Kr(t, e, n) {
  ...
  if (
    ...
    (r = t.ref) && ((r.current && r.current !== t.__e) || Jr(r, null, e)),
    (r = t.__c) != null)
  ) {
...
function Ne(t, e, n) {
  ...
  ;(S.__ && S.__(t, e),
    ...
    nn(
      ...
      i ? null : e.firstChild ? ht.call(e.childNodes) : null,
      s,
...
;((ht = Vr.slice),
  ...
  (U.prototype.setState = function (t, e) {
    ...
    ;((n =
      ...
      typeof t == 'function' && (t = t(K({}, n), this.props)),
      t && K(n, t),
...
function zs() {
  for (var t; (t = ei.shift()); )
    if (t.__P && t.__H)
      try {
        ;(t.__H.__h.forEach(qe), t.__H.__h.forEach(Ft), (t.__H.__h = []))
      } catch (e) {
  ...
  (S.__r = function (t) {
    ...
    ;(e &&
      (St === V
        ...
        : (e.__h.forEach(qe), e.__h.forEach(Ft), (e.__h = []))),
      (St = V))
  }),
  (S.diffed = function (t) {
    Gn && Gn(t)
    ...
    ;(e &&
      e.__H &&
      (e.__H.__h.length &&
        ((ei.push(e) !== 1 && Fn === S.requestAnimationFrame) ||
          ((Fn = S.requestAnimationFrame) || Fs)(zs)),
...
;((($n.prototype = new U()).isPureReactComponent = !0),
...
S.__e = function (t, e, n, r) {
  if (t.then) {
    for (var i, s = e; (s = s.__); )
      if ((i = s.__c) && i.__c)
        return (
          e.__e == null && ((e.__e = n.__e), (e.__k = n.__k)),
          i.__c(t, e)
        )
  }
  Vs(t, e, n, r)
...
;((S.unmount = function (t) {
  ...
  ((Dt.prototype = new U()).__c = function (t, e) {
    var n = e.__c,
      r = this
  ...
  ;((e.componentWillUnmount = function () {
    ...
    t.__v
      ? (e.l ||
        ...
        Ne(g(Gs, { context: e.context }, t.__v), e.l))
      : e.l && e.componentWillUnmount())
}
function Qs(t, e) {
  var n = g(qs, { __v: t, i: e })
  return ((n.containerInfo = e), n)
}
;(((Le.prototype = new U()).__a = function (t) {
  var e = this,
    n = ri(e.__v),
    r = e.o.get(t)
  return (
...
S.vnode = function (t) {
  ...
  if (typeof e == 'string') {
    ...
    ;(e == 'select' &&
      ...
      (r.value = et(n.children).forEach(function (o) {
      ...
      (t.props = r),
      n.class != n.className &&
        ((tr.enumerable = 'className' in n),
        n.className != null && (r.class = n.className),
        Object.defineProperty(r, 'className', tr)))
  }
  ;((t.$$typeof = Ys), nr && nr(t))
}
var rr = S.__r
...
function tl(t) {
  t.isConnected && t.getRootNode && si(t.getRootNode())
}
function si(t) {
  let e = Wt.get(t)
  if (!e || !e.isConnected) {
...
class sn {
  ...
  resume(e = '', n) {
    ...
    e in r &&
      (n ? delete r[e] : ((r[e] -= 1), r[e] <= 0 && delete r[e]),
      this.tryDrain())
  }
  isPaused() {
...
function fl(t) {
  ;((t.style.userSelect = 'none'),
    ...
    t.addEventListener('selectstart', pt))
}
function hl(t) {
  ;((t.style.userSelect = ''),
    (t.style.webkitUserSelect = ''),
    t.removeEventListener('selectstart', pt))
}
function gl(t) {
  t.addEventListener('contextmenu', pt)
}
function pl(t) {
  t.removeEventListener('contextmenu', pt)
}
function ml(t) {
  let e = [],
    n = [],
...
function vl(t, e, n) {
  let r, i
  for (r = 0; r < n.length; r += 1) if (((i = bl(t, e, n[r])), i)) return i
  return 0
}
function bl(t, e, n) {
  return n.func ? n.func(t, e) : yl(t[n.field], e[n.field]) * (n.order || 1)
}
function yl(t, e) {
  return !t && !e
    ? 0
...
const or = ['years', 'months', 'days', 'milliseconds'],
...
function cn(t, e) {
  ...
  for (let r = 0; r < or.length; r += 1) {
    ...
    if (e[i]) {
      let s = t[i] / e[i]
      if (!Qe(s) || (n !== null && n !== s)) return null
      n = s
...
function tt(t, e) {
  return te(t) === te(e) ? Math.round(se(t, e)) : null
}
function M(t) {
  return L([t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate()])
}
function Hl(t) {
  return L([
    t.getUTCFullYear(),
...
function Ul(t, e, n) {
  let r = t.getUTCFullYear(),
    i = Ct(t, r, e, n)
  if (i < 1) return Ct(t, r - 1, e, n)
  let s = Ct(t, r + 1, e, n)
  return s >= 1 ? Math.min(i, s) : i
}
function Ct(t, e, n, r) {
  let i = L([e, 0, 1 + jl(e, n, r)]),
    s = M(t),
    l = Math.round(se(i, s))
...
function Fl(t) {
  return (
    ye(t.getUTCHours(), 2) +
    ':' +
    ye(t.getUTCMinutes(), 2) +
    ':' +
    ye(t.getUTCSeconds(), 2)
  )
}
function un(t, e = !1) {
  let n = t < 0 ? '-' : '+',
...
function Ye(t, e, n) {
  let r, i
  return s => (
    r ? W(r, s) || (i = t.call(this, s)) : (i = t.call(this, s)),
    (r = s),
    i
  )
}
...
class Ql {
  constructor(e) {
    ...
    for (let s in e)
      s in Rt
        ? ((r[s] = e[s]), Rt[s] < 9 && (i = Math.min(Rt[s], i)))
        : ((n[s] = e[s]), s in nt && (i = Math.min(nt[s], i)))
    ;((this.standardDateProps = n),
      (this.extendedSettings = r),
      (this.smallestUnitNum = i),
      (this.buildFormattingFunc = A(fr)))
  }
  format(e, n) {
  ...
  formatRange(e, n, r, i) {
    ...
    let h = eo(s, a),
      ...
      m = f(n),
      v = to(d, u, c, m),
      b = l.separator || i || r.defaultSeparator || ''
...
function $l(t, e, n, r, i) {
  return (
    ...
    r.meridiem === !1
      ? (t = t.replace(Ue, '').trim())
      : r.meridiem === 'narrow'
        ? (t = t.replace(Ue, (s, l) => l.toLocaleLowerCase()))
        : r.meridiem === 'short'
          ? (t = t.replace(Ue, (s, l) => `${l.toLocaleLowerCase()}m`))
          : r.meridiem === 'lowercase' &&
            (t = t.replace(Ue, s => s.toLocaleLowerCase())),
    (t = t.replace(Vl, ' ')),
    (t = t.trim()),
    t
  )
...
function eo(t, e) {
  let n = {}
  for (let r in t) (!(r in nt) || nt[r] <= e) && (n[r] = t[r])
  return n
}
function to(t, e, n, r) {
  let i = 0
...
function rt(t, e, n, r) {
  let i = hr(t, n.calendarSystem),
    s = e ? hr(e, n.calendarSystem) : null
  return {
    date: i,
    start: i,
    end: s,
...
function W(t, e) {
  if (t === e) return !0
  for (let n in t) if (it.call(t, n) && !(n in e)) return !1
  for (let n in e) if (it.call(e, n) && t[n] !== e[n]) return !1
  return !0
}
const so = /^on[A-Z]/
function lo(t, e) {
...
function oo(t, e) {
  let n = []
  for (let r in t) it.call(t, r) && (r in e || n.push(r))
  for (let r in e) it.call(e, r) && t[r] !== e[r] && n.push(r)
  return n
}
function Tt(t, e, n = {}) {
  if (t === e) return !0
  for (let r in e) if (!(r in t && ao(t[r], e[r], n[r]))) return !1
...
class mo {
  constructor(e) {
    ...
    ;(e.namedTimeZoneImpl &&
      ...
      (this.calendarSystem = fo(e.calendarSystem)),
  ...
  diffWholeMonths(e, n) {
    let { calendarSystem: r } = this
    return te(e) === te(n) && r.getMarkerDay(e) === r.getMarkerDay(n)
      ? r.getMarkerMonth(n) -
          r.getMarkerMonth(e) +
  ...
  countDurationsBetween(e, n, r) {
    ...
    return r.years && ((i = this.diffWholeYears(e, n)), i !== null)
      ...
      : r.months && ((i = this.diffWholeMonths(e, n)), i !== null)
        ? i / Tl(r)
        : r.days && ((i = tt(e, n)), i !== null)
          ? i / Ee(r)
          : (n.valueOf() - e.valueOf()) / F(r)
  }
  startOf(e, n) {
    return n === 'year'
      ? this.startOfYear(e)
  ...
  timestampToMarker(e) {
    return this.timeZone === 'local'
      ...
      : this.timeZone === 'UTC' || !this.namedTimeZoneImpl
        ? new Date(e)
        : L(this.namedTimeZoneImpl.timestampToArray(e))
  }
  offsetForMarker(e) {
    return this.timeZone === 'local'
      ? -ur(ee(e)).getTimezoneOffset()
      : this.timeZone === 'UTC'
        ? 0
        : this.namedTimeZoneImpl
          ? this.namedTimeZoneImpl.offsetForArray(ee(e))
          : null
  }
  toDate(e, n) {
    return this.timeZone === 'local'
      ...
      : this.timeZone === 'UTC'
        ...
        : this.namedTimeZoneImpl
          ? new Date(
              e.valueOf() -
                this.namedTimeZoneImpl.offsetForArray(ee(e)) * 1e3 * 60
            )
...
Pe.prototype.baseIconClass = ''
Pe.prototype.iconOverridePrefix = ''
function st(t) {
  t()
  let e = S.debounceRendering,
    n = []
  function r(i) {
    n.push(i)
  }
  for (
    S.debounceRendering = r, Ne(g(vo, {}), document.createElement('div'));
    n.length;
...
const $ = mi({})
function yo(t, e, n, r, i, s, l, o, a, d, c, h, f, u) {
  return {
    dateEnv: i,
    nowManager: s,
    options: n,
    ...
    createScrollResponder(m) {
      return new bo(m, c, C(n.scrollTime), n.scrollTimeReset)
    },
...
class me extends U {
  shouldComponentUpdate(e, n) {
    return (
      ...
      !Tt(this.state, n, this.stateEquality)
    )
  }
  safeSetState(e) {
    Tt(
...
me.addPropsEquality = Eo
me.addStateEquality = So
me.contextType = $
      ...
      if (f === !0) a = !0
        ...
        u && 'html' in f
          ...
          : u && 'domNodes' in f
            ...
            : (u ? zr(f) : typeof f != 'function')
              ? (d = f)
              : (h = f)
      }
    } else a = !qt(e.generatorName, r)
    return (
      a && s && (d = s(l)),
      ...
      o &&
        s(
          Object.assign(
            ...
            { elClasses: (r.elClasses || []).filter(Ao) }
          )
        )
    }
  }
...
pn.addPropsEquality({ elClasses: re, elStyle: W, elAttrs: lo, renderProps: W })
function qt(t, e) {
  var n
  return !!(
...
class z extends U {
  constructor() {
    ;(super(...arguments),
      (this.InnerContent = Do.bind(void 0, this)),
      (this.handleEl = e => {
        ;((this.el = e),
          this.props.elRef &&
  ...
  render() {
    const { props: e } = this,
      n = wo(e.classNameGenerator, e.renderProps)
    if (e.children) {
      const r = vi(e, n, this.handleEl),
  ...
  render() {
    ...
    return g(
      z,
      {
        ...
        elTag: e.elTag || 'div',
        elAttrs: e.elAttrs,
        elClasses: [...yi(e.viewSpec), ...(e.elClasses || [])],
        elStyle: e.elStyle,
        renderProps: i,
...
function vr(t, e) {
  let n = [],
    ...
    i,
    s
  for (t.sort(Ro), i = 0; i < t.length; i += 1)
    ((s = t[i]),
...
function Ei(t) {
  let e = Math.floor(se(t.start, t.end)) || 1,
    n = M(t.start),
    r = P(n, e)
...
function vn(t, e = C(0)) {
  ...
  return (
    t.start && ((n = M(t.start)), r && r <= n && (r = P(n, 1))),
    { start: n, end: r }
  )
}
function Ef(t) {
  let e = vn(t)
  return se(e.start, e.end) > 1
}
function be(t, e, n, r) {
  return r === 'year'
    ? C(n.diffWholeYears(t, e), 'year')
    : r === 'month'
      ? C(n.diffWholeMonths(t, e), 'month')
      : Ol(t, e)
}
class Si {
  constructor(e) {
  ...
  build(e, n, r = !0) {
    ...
    return (
      ...
      (d = a),
      i.showNonCurrentDates || (d = he(d, l.range)),
  ...
  adjustActiveRange(e) {
    ...
    return (
      r &&
        (Ee(i) < 0 && ((l = M(l)), (l = n.add(l, i))),
        Ee(s) > 1 && ((o = M(o)), (o = P(o, -1)), (o = n.add(o, s)))),
      { start: l, end: o }
    )
  }
  buildRangeFromDuration(e, n, r, i) {
    ...
    if (!l) {
      ...
      h && F(h) < F(r) ? (l = Gt(h).unit) : (l = i)
    }
    Ee(r) <= 1 &&
      this.isHiddenDay(o) &&
      ((o = this.skipHiddenDays(o, n)), (o = M(o)))
    function c() {
      ;((o = s.startOf(e, l)), (a = s.add(o, r)), (d = { start: o, end: a }))
    }
    return (
      c(),
      this.trimHiddenDays(d) || ((e = this.skipHiddenDays(e, n)), c()),
      d
    )
  }
  ...
  buildCustomVisibleRange(e) {
    let { props: n } = this,
      ...
      i =
        typeof r == 'function' ? r.call(n.calendarApi, n.dateEnv.toDate(e)) : r,
...
function ge(t, e, n) {
  ...
  o = fe(o, a => !l[a.defId].recurringDef)
  for (let a in l) {
    let d = l[a]
    if (d.recurringDef) {
      ...
      for (let f of h) {
        let u = bn(a, { start: f, end: r.add(f, c) })
        o[u.instanceId] = u
      }
    }
  }
...
const Ze = {
  ...
  Ai = { start: p, end: p, date: p, allDay: Boolean },
  Io = Object.assign(Object.assign(Object.assign({}, Ze), Ai), {
    extendedProps: p,
  })
function Di(t, e, n, r, i = yn(n), s, l) {
  let { refined: o, extra: a } = wi(t, n, i),
    d = No(e, n),
    c = xo(o, d, n.dateEnv, n.pluginHooks.recurringTypes)
  if (c) {
    let f = Qt(o, a, e ? e.sourceId : '', c.allDay, !!c.duration, n, s)
    return (
      (f.recurringDef = {
        typeId: c.typeId,
        typeData: c.typeData,
  ...
  let h = ko(o, d, n, r)
  if (h) {
    let f = Qt(o, a, e ? e.sourceId : '', h.allDay, h.hasEnd, n, s),
      u = bn(f.defId, h.range, h.forcedStartTzo, h.forcedEndTzo)
    return (
      l && f.publicId && l[f.publicId] && (u.instanceId = l[f.publicId]),
      { def: f, instance: u }
    )
  }
  return null
...
function yn(t) {
  return Object.assign(
    Object.assign(Object.assign({}, ot), Io),
    t.pluginHooks.eventRefiners
  )
}
function Qt(t, e, n, r, i, s, l) {
  let o = {
    title: t.title || '',
    groupId: t.groupId || '',
    publicId: t.id || '',
...
function ko(t, e, n, r) {
  ...
  return (
    ...
    i && l && (l = M(l)),
    a && ((d = a.marker), i && (d = M(d)), l && d <= l && (d = null)),
    d
      ? (o = !0)
      : r ||
...
function _i(t) {
  return Object.assign(
    Object.assign(Object.assign({}, ot), Uo),
...
function zo(t, e, n, r, i) {
  switch (e.type) {
    ...
    case 'RESET_RAW_EVENTS':
      return Wo(t, n[e.sourceId], e.rawEvents, r.activeRange, i)
    case 'ADD_EVENTS':
      return Vo(t, e.eventStore, r ? r.activeRange : null, i)
    case 'RESET_EVENTS':
      return e.eventStore
    case 'MERGE_EVENTS':
    ...
    case 'CHANGE_VIEW_TYPE':
      return r ? ge(t, r.activeRange, i) : t
    case 'REMOVE_EVENTS':
      return Po(t, e.eventStore)
    case 'REMOVE_EVENT_SOURCE':
      return xi(t, e.sourceId)
...
function Fo(t, e, n, r, i, s) {
  if (e && n === e.latestFetchId) {
    let l = Oe(Ti(i, e, s), e, s)
    return (r && (l = ge(l, r, s)), Sn(xi(t, e.sourceId), l))
  }
  return t
}
function Wo(t, e, n, r, i) {
  const { defIdMap: s, instanceIdMap: l } = qo(t)
  let o = Oe(Ti(n, e, i), e, i, !1, s, l)
  return ge(o, r, i)
}
function Ti(t, e, n) {
...
function Go(t, e) {
  return { defs: t.defs, instances: fe(t.instances, n => !e[n.instanceId]) }
}
function qo(t) {
    ...
    t === !0
      ...
      : Array.isArray(t)
        ...
        : typeof t == 'object' && t
          ? (e = [t])
          : (e = []),
    (e = e.map(n => Object.assign(Object.assign({}, Zo), n))),
    e
  )
}
function Mi(t, e, n) {
  n.emitter.trigger(
    'select',
    Object.assign(Object.assign({}, An(t, n)), {
...
function An(t, e) {
  ...
  return (Object.assign(n, fa(t, e.dateEnv)), n)
}
function Sr(t, e, n) {
  ...
  return (
    t
      ? ((s = M(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
...
function Dn(t, e, n, r) {
  ...
  for (let l in t.defs) {
    let o = t.defs[l]
    s.defs[l] = Ko(o, i[l], n, r)
  }
  for (let l in t.instances) {
    let o = t.instances[l],
      a = s.defs[o.defId]
    s.instances[l] = ea(o, a, i[o.defId], n, r)
  }
  return s
}
function Ko(t, e, n, r) {
...
function ea(t, e, n, r, i) {
  ...
  return (
    ...
    o &&
      (a.range = { start: a.range.start, end: Sr(e.allDay, a.range.start, i) }),
    e.allDay && (a.range = { start: M(a.range.start), end: M(a.range.end) }),
    a.range.end < a.range.start &&
      (a.range.end = Sr(e.allDay, a.range.start, i)),
    a
  )
}
class ve {
...
class k {
  ...
  setProp(e, n) {
    if (e in Ai)
      ...
      ((n = Ze[e](n)), this.mutate({ standardProps: { publicId: n } }))
    else if (e in Ze)
      ((n = Ze[e](n)), this.mutate({ standardProps: { [e]: n } }))
    else if (e in ot) {
      let r = ot[e](n)
      ;(e === 'color'
  ...
  get source() {
    ...
    return e
      ? new ve(this._context, this._context.getCurrentData().eventSources[e])
      : null
  }
  get start() {
...
function de(t, e, n) {
  ...
  for (let o in i) {
    let a = i[o],
      d = r[a.defId]
    a.instanceId !== l && s.push(new k(e, d, a))
  }
  return s
}
function Ar(t, e, n, r) {
...
function Oi(t, e, n, r, i, s, l) {
  ...
  let u = f.range.start,
    ...
    b = l || t.end || t.eventRange.range.end,
    y = M(u).valueOf() === M(v).valueOf(),
    E = M(ie(m, -1)).valueOf() === M(ie(b, -1)).valueOf()
  return d && !h.allDay && (y || E)
    ? ((v = y ? u : v),
      ...
      c && h.hasEnd
        ...
        : o.format(v, e, { forcedTzo: s ? null : f.forcedStartTzo }))
    : ''
}
function ne(t, e, n) {
...
const oa = { start: p, end: p, allDay: Boolean }
function aa(t, e, n) {
  let r = ca(t, e),
    { range: i } = r
...
function da(t, e) {
  return _o(t.range, e.range) && t.allDay === e.allDay && ua(t, e)
}
function ua(t, e) {
  for (let n in e)
...
function ha(t, e, n) {
  let r = wi({ editable: !1 }, n),
    i = Qt(r.refined, r.extra, '', t.allDay, !0, n)
  return {
    def: i,
    ui: ki(i, e),
...
class Re extends U {
  ...
  computeTiming() {
    let { props: e, context: n } = this,
      r = n.nowManager.getDateMarker(),
      { nowIndicatorSnap: i } = n.options
    i === 'auto' &&
      (i = /year|month|week|day/.test(e.unit) || (e.unitValue || 1) === 1)
    let s, l
    return (
      i
        ? ((s = n.dateEnv.startOf(r, e.unit)),
          (l = n.dateEnv.add(s, C(1, e.unit)).valueOf() - r.valueOf()))
        : ((s = r), (l = 1e3 * 60)),
      (l = Math.min(1e3 * 60 * 60 * 24, l)),
      { state: { nowDate: s, todayRange: ya(s) }, waitMs: l }
    )
  }
...
class Ea {
  ...
  select(e, n) {
    ...
    let i = this.getCurrentData(),
      s = aa(r, i.dateEnv, C({ days: 1 }))
    s && (this.dispatch({ type: 'SELECT_DATES', selection: s }), Mi(s, null, i))
  }
  unselect(e) {
    let n = this.getCurrentData()
  ...
  addEvent(e, n) {
    if (e instanceof k) {
      ...
      return (
        this.getCurrentData().eventStore.defs[l.defId] ||
          (this.dispatch({
            type: 'ADD_EVENTS',
            eventStore: Yt({ def: l, instance: o }),
          }),
    ...
    else if (typeof n == 'boolean') n && ([i] = gn(r.eventSources))
    else if (n != null) {
      let l = this.getEventSourceById(n)
      if (!l)
        return (
          console.warn(`Could not find an event source with ID "${n}"`),
          null
        )
    ...
    let s = Di(e, i, r, !1)
    if (s) {
      let l = new k(r, s.def, s.def.recurringDef ? null : s.instance)
      return (
        this.dispatch({ type: 'ADD_EVENTS', eventStore: Yt(s) }),
  ...
  triggerEventAdd(e) {
    ...
    n.trigger('eventAdd', {
      ...
      relatedEvents: [],
      revert: () => {
        this.dispatch({ type: 'REMOVE_EVENTS', eventStore: Ii(e) })
      },
    })
  }
  getEventById(e) {
    ...
    for (let s in r) {
      let l = r[s]
      if (l.publicId === e) {
        if (l.recurringDef) return new k(n, l, null)
        for (let o in i) {
          let a = i[o]
          if (a.defId === l.defId) return new k(n, l, a)
        }
      }
    }
    return null
...
class Ca {
  constructor() {
    ;((this.getKeysForEventDefs = A(this._getKeysForEventDefs)),
      (this.splitDateSelection = A(this._splitDateSpan)),
      (this.splitEventStore = A(this._splitEventStore)),
      (this.splitIndividualUi = A(this._splitIndividualUi)),
      (this.splitEventDrag = A(this._splitInteraction)),
      (this.splitEventResize = A(this._splitInteraction)),
  ...
  splitProps(e) {
    let n = this.getKeyInfo(e),
      ...
      d = {}
    this.eventUiBuilders = Z(n, (c, h) => this.eventUiBuilders[h] || A(Ra))
    for (let c in n) {
      let h = n[c],
        f = l[c] || Mt,
  ...
  _getKeysForEventDefs(e) {
    return Z(e.defs, n => this.getKeysForEventDef(n))
  }
  _splitEventStore(e, n) {
    let { defs: r, instances: i } = e,
      s = {}
    for (let l in r)
      for (let o of n[l]) (s[o] || (s[o] = j()), (s[o].defs[l] = r[l]))
    for (let l in i) {
      let o = i[l]
...
function zi(t, e, n, r) {
  return {
    dow: t.getUTCDay(),
    isDisabled: !!(r && (!r.activeRange || !Y(r.activeRange, t))),
...
const _a = N({ year: 'numeric', month: 'long', day: 'numeric' }),
  Ta = N({ week: 'long' })
function dt(t, e, n = 'day', r = !0) {
  const { dateEnv: i, options: s, calendarApi: l } = t
  let o = i.format(e, n === 'week' ? Ta : _a)
  if (s.navLinks) {
    let a = i.toDate(e)
    const d = c => {
      let h =
    ...
    return Object.assign(
      { title: Me(s.navLinkHint, [o, a], o), 'data-navlink': '' },
      r ? di(d) : { onClick: d }
    )
  }
  return { 'aria-label': o }
...
class we {
  ...
  similarTo(e) {
    return (
      ze(this.tops || [], e.tops || []) &&
      ze(this.bottoms || [], e.bottoms || []) &&
      ze(this.lefts || [], e.lefts || []) &&
      ze(this.rights || [], e.rights || [])
    )
  }
}
function ze(t, e) {
...
class Vi {
  ...
  handleInvalidInsertion(e, n, r) {
    if (this.allowReslicing && e.touchingEntry) {
      const i = Object.assign(Object.assign({}, n), {
        span: Tn(n.span, e.touchingEntry.span),
      })
  ...
  insertEntryAt(e, n) {
    ...
    ;(n.lateral === -1
      ? (Nt(i, n.level, n.levelCoord), Nt(r, n.level, [e]))
      : Nt(r[n.level], n.lateral, e),
  ...
  findInsertion(e) {
    ...
    for (let m = 0; m < l; m += 1) {
      ...
      let b = r[m],
        y,
        E = Xt(b, e.span.start, $t),
        D = E[0] + E[1]
      for (; (y = b[D]) && y.span.start < e.span.end; ) {
        let w = v + this.getEntryThickness(y)
        ;(w > o && ((o = w), (c = y), (a = m), (d = D)),
          w === o && (h = Math.max(h, s[ue(y)] + 1)),
          (D += 1))
      }
    }
    let f = 0
    ...
    let u = -1
    return (
      f < l && n[f] === o && (u = Xt(r[f], e.span.end, $t)[0]),
      {
        touchingLevel: a,
        touchingLateral: d,
        touchingEntry: c,
...
class Fa extends _ {
  render() {
    let { dateEnv: e, options: n, theme: r, viewApi: i } = this.context,
      ...
      a = zi(l, s.todayRange, null, o),
      d = [Gi].concat(Cn(a, r)),
      c = e.format(l, s.dayHeaderFormat),
      h = !a.isDisabled && s.colCnt > 1 ? dt(this.context, l) : {},
      f = e.toDate(l)
    e.namedTimeZoneImpl && (f = ie(f, 36e5))
    let u = Object.assign(
      Object.assign(Object.assign({ date: f, view: i }, s.extraRenderProps), {
        text: c,
      }),
      a
    )
        ...
        elAttrs: Object.assign(
          {
            role: 'columnheader',
            colSpan: s.colSpan,
            'data-date': a.isDisabled ? void 0 : dn(l),
          },
          s.extraDataAttrs
        ),
        renderProps: u,
...
class Va extends _ {
  render() {
    ...
    return g(
      ...
      {
        elTag: 'th',
        elClasses: [Gi, ...Cn(o, r), ...(e.extraClassNames || [])],
        elAttrs: Object.assign(
      ...
      c =>
        g(
          ...
          g(c, {
            ...
            elAttrs: { 'aria-label': n.format(l, Wa) },
          })
        )
    )
  }
...
class Qi extends _ {
  constructor() {
    ;(super(...arguments), (this.createDayHeaderFormatter = A(Ga)))
  }
  render() {
    let { context: e } = this,
      {
...
class Yi {
  ...
  getDateDayIndex(e) {
    let { indices: n } = this,
      r = Math.floor(se(this.dates[0], e))
...
class $i {
  constructor() {
    ;((this.sliceBusinessHours = A(this._sliceBusinessHours)),
      (this.sliceDateSelection = A(this._sliceDateSpan)),
      (this.sliceEventStore = A(this._sliceEventStore)),
  ...
  _sliceBusinessHours(e, n, r, i, ...s) {
    return e
      ? this._sliceEventStore(ge(e, Fe(n, !!r), i), {}, n, r, ...s).bg
      : []
  }
  _sliceEventStore(e, n, r, i, ...s) {
    if (e) {
      let l = Ar(e, n, Fe(r, !!i), i)
      return {
  ...
  _sliceInteraction(e, n, r, i, ...s) {
    if (!e) return null
    let l = Ar(e.mutatedEvents, n, Fe(r, !!i), i)
    return {
...
function Xi(t, e, n) {
  ...
  for (let i in r) if (!mt(e.validRange, r[i].range)) return !1
  return Ji({ eventDrag: t }, n)
}
function qa(t, e, n) {
  return mt(e.validRange, t.range) ? Ji({ dateSelection: t }, n) : !1
}
function Ji(t, e) {
...
function Qa(t, e, n = {}, r) {
  return !(
    (t.eventDrag && !Ya(t, e, n, r)) ||
    (t.dateSelection && !Za(t, e, n, r))
  )
}
function Ya(t, e, n, r) {
  let i = e.getCurrentData(),
    ...
    o = l.defs,
    a = l.instances,
    d = ct(o, s.isEvent ? t.eventUiBases : { '': i.selectionConfig })
  r && (d = Z(d, r))
  let c = Go(t.eventStore, s.affectedEvents.instances),
    h = c.defs,
    f = c.instances,
    u = ct(h, t.eventUiBases)
  for (let m in a) {
    let v = a[m],
      b = v.range,
      y = d[v.defId],
      E = o[v.defId]
    if (!Ki(y.constraints, b, c, t.businessHours, e)) return !1
    let { eventOverlap: D } = e.options,
      w = typeof D == 'function' ? D : null
    for (let T in f) {
      let I = f[T]
      if (
        mn(b, I.range) &&
        ((u[I.defId].overlap === !1 && s.isEvent) ||
          y.overlap === !1 ||
          (w && !w(new k(e, h[I.defId], I), new k(e, E, v))))
      )
        return !1
    }
    let O = i.eventStore
    for (let T of y.allows) {
      let I = Object.assign(Object.assign({}, n), {
        ...
        J = O.instances[m],
        _e
      if ((R ? (_e = new k(e, R, J)) : (_e = new k(e, E)), !T(An(I, e), _e)))
        return !1
    }
  }
  return !0
...
function Za(t, e, n, r) {
  ...
  if ((r && (d = r(d)), !Ki(d.constraints, a, i, t.businessHours, e))) return !1
  ...
  for (let f in l) {
    ...
    if (
      mn(a, u.range) &&
      (d.overlap === !1 || (h && !h(new k(e, s[u.defId], u), null)))
    )
      return !1
  }
  for (let f of d.allows) {
    let u = Object.assign(Object.assign({}, n), o)
    if (!f(An(u, e), null)) return !1
  }
  return !0
}
function Ki(t, e, n, r, i) {
  for (let s of t) if (!Xa($a(s, e, n, r, i), e)) return !1
  return !0
}
...
function Xa(t, e) {
  for (let n of t) if (mt(n, e)) return !0
  return !1
}
const We = /^(visible|hidden)$/
class Ja extends _ {
  constructor() {
    ;(super(...arguments),
      (this.handleEl = e => {
  ...
  needsXScrolling() {
    if (We.test(this.props.overflowX)) return !1
    let { el: e } = this,
  ...
  needsYScrolling() {
    if (We.test(this.props.overflowY)) return !1
    let { el: e } = this,
  ...
  getXScrollbarWidth() {
    return We.test(this.props.overflowX)
      ? 0
      : this.el.offsetHeight - this.el.clientHeight
  }
  getYScrollbarWidth() {
    return We.test(this.props.overflowY)
      ? 0
...
class Q {
  ...
  collect(e, n, r) {
    return co(this.currentMap, e, n, r)
  }
  getAll() {
...
class Mn extends _ {
  constructor() {
    ;(super(...arguments),
      (this.processCols = A(e => e, nc)),
      (this.renderMicroColGroup = A(rc)),
  ...
  render() {
    ...
    return g(
      ...
      !!(!m && h.length) && g('thead', v, ...h),
      !!(!m && f.length) && g('tbody', v, ...f),
      !!(!m && u.length) && g('tfoot', v, ...u),
      m && g('tbody', v, ...h, ...f, ...u)
    )
  }
  renderSection(e, n, r) {
    return 'outerContent' in e
      ? g(x, { key: e.key }, e.outerContent)
      : g(
          'tr',
          {
            key: e.key,
...
Mn.addStateEquality({ scrollerClientWidths: W, scrollerClientHeights: W })
function ac(t, e) {
...
class In extends _ {
  constructor() {
    ;(super(...arguments),
      (this.buildPublicEvent = A((e, n, r) => new k(e, n, r))),
      (this.handleEl = e => {
        ;((this.el = e), G(this.props.elRef, e), e && Dr(e, this.props.seg))
      }))
  }
  render() {
    const { props: e, context: n } = this,
      ...
      o = {
        ...
        isDraggable: !e.disableDragging && ra(i, n),
        isStartResizable: !e.disableResizing && ia(i, n),
  ...
  componentDidUpdate(e) {
    this.el && this.props.seg !== e.seg && Dr(this.el, this.props.seg)
  }
}
class kn extends _ {
  render() {
    let { props: e, context: n } = this,
      ...
      o = Oi(i, l, n, e.defaultDisplayEventTime, e.defaultDisplayEventEnd)
    return g(
      In,
      Object.assign({}, e, {
        elTag: 'a',
...
class On extends _ {
  constructor() {
    ;(super(...arguments), (this.refineRenderProps = Ye(uc)))
  }
  render() {
    let { props: e, context: n } = this,
      { options: r } = n,
    ...
    return g(
      z,
      {
        ...
        elAttrs: Object.assign(
          ...
          i.isDisabled ? {} : { 'data-date': dn(e.date) }
        ),
        elClasses: [...Cn(i, n.theme), ...(e.elClasses || [])],
        elStyle: e.elStyle,
        renderProps: i,
...
class gc extends _ {
  ...
  updateSize() {
    ...
    if (s) {
      ...
      ;((o = Math.max(o, Pt)),
        (a = Math.min(a, document.documentElement.clientWidth - Pt - l.width)),
        (a = Math.max(a, Pt)))
      let d = i.offsetParent.getBoundingClientRect()
      xe(i, { top: o - d.top, left: a - d.left })
    }
  }
}
class pc extends q {
    ...
    return g(
      ...
      (a, d, c) =>
        g(
          ...
          Pn(e) && g(a, { elTag: 'div', elClasses: ['fc-more-popover-misc'] }),
          r.children
        )
    )
  }
...
class ss extends _ {
  constructor() {
    ;(super(...arguments),
      (this.state = { isPopoverOpen: !1, popoverId: gt() }),
      (this.handleLinkEl = e => {
...
function bc(t) {
  return t.reduce(yc).eventRange.range.end
}
function yc(t, e) {
...
class Ec {
  ...
  subscribe(e) {
    ;(this.handlers.push(e),
      this.currentValue !== void 0 && e(this.currentValue))
  }
}
class Sc extends Ec {
  constructor() {
...
const Ac = [],
  ...
  as = Object.assign(Object.assign({}, os), {
    buttonHints: {
      prev: 'Previous $0',
      next: 'Next $0',
      today(t, e) {
...
function Tc(t, e) {
  return {
    premiumReleaseDate: xc(t.premiumReleaseDate, e.premiumReleaseDate),
...
function Mc(t, e) {
  let n = {},
    r
  for (r in t) Kt(r, n, t, e)
  for (r in e) Kt(r, n, t, e)
  return n
}
function Kt(t, e, n, r) {
  if (e[t]) return e[t]
  ...
  return (
    e.content
      ...
      : n &&
        ...
        (n = _r(Object.assign(Object.assign({}, e), { content: n }))),
...
function Oc(t, e, n, r, i) {
  ...
  if (s && ((l = Pc(s)), l)) {
    let f = Gt(l)
    ;((o = f.unit),
      f.value === 1 && ((a = o), (d = e[o] ? e[o].rawOptions : {})))
  }
  let c = f => {
      let u = f.buttonText || {},
  ...
  return {
    ...
    buttonTextDefault: c(i) || t.defaults.buttonText || c(Ie) || t.type,
    buttonTitleOverride: h(r) || h(n) || t.overrides.buttonHint,
    buttonTitleDefault: h(i) || t.defaults.buttonHint || h(Ie),
  }
}
let Tr = {}
function Pc(t) {
  let e = JSON.stringify(t),
    n = Tr[e]
  return (n === void 0 && ((n = C(t)), (Tr[e] = n)), n)
}
function Hc(t, e) {
  switch (e.type) {
    case 'CHANGE_VIEW_TYPE':
...
function zc(t, e, n) {
  ...
  return fs({}, Yc(t, n), r, n)
}
function Fc(t, e, n, r) {
  let i = n ? n.activeRange : null
  switch (e.type) {
    case 'ADD_EVENT_SOURCES':
      return fs(t, e.sources, i, r)
    case 'REMOVE_EVENT_SOURCE':
    ...
    case 'FETCH_EVENT_SOURCES':
      return Hn(
        t,
        e.sourceIds ? gi(e.sourceIds) : gs(t, r),
        i,
        e.isRefetch || !1,
        r
      )
    ...
    case 'RECEIVE_EVENT_ERROR':
      return Qc(t, e.sourceId, e.fetchId, e.fetchRange)
    case 'REMOVE_ALL_EVENT_SOURCES':
      return {}
    default:
      return t
...
function fs(t, e, n, r) {
  ...
  return (n && (i = hs(i, n, r)), Object.assign(Object.assign({}, t), i))
}
function Vc(t, e) {
...
function Kc(t, e, n, r, i) {
  let s = t.headerToolbar ? xr(t.headerToolbar, t, e, n, r, i) : null,
    l = t.footerToolbar ? xr(t.footerToolbar, t, e, n, r, i) : null
      ...
      b.split(',').map(y => {
        ...
        if ((E = o[y]))
          ...
          if (
            ...
            (T = a[y]) || (O = r.getIconClass(y, l)) || (T = d[y]),
            y === 'prevYear' || y === 'nextYear')
          ) {
            let R = y === 'prevYear' ? 'prev' : 'next'
            I = Me(c[R] || h[R], [d.year || 'year', 'year'], d[y])
          } else I = R => Me(c[y] || h[y], [d[R] || R, R], d[y])
        return {
          buttonName: y,
          buttonClick: w,
          buttonIcon: O,
...
const rd = X({ name: 'array-event-source', eventSourceDefs: [nd] })
let id = {
  parseMeta(t) {
  ...
  fetch(t, e, n) {
    ...
    ga(i.bind(null, Bi(t.range, r)), s => e({ rawEvents: s }), n)
  },
}
const sd = X({ name: 'func-event-source', eventSourceDefs: [id] }),
  ld = {
    method: String,
    extraParams: p,
    startParam: String,
...
let ud = {
  parse(t, e) {
    if (
      ...
      return (
        ...
        !r && t.startTime && t.endTime && (r = Cl(t.endTime, t.startTime)),
  ...
  expand(t, e, n) {
    ...
    return r ? hd(t.daysOfWeek, t.startTime, t.dateEnv, n, r) : []
  },
}
const fd = X({
...
function hd(t, e, n, r, i) {
  ...
  for (
    ...
    (e.milliseconds < 0
      ? (o = P(o, 1))
      : e.milliseconds >= 1e3 * 60 * 60 * 24 && (l = P(l, -1)));
    l < o;

  ) {
    let d
    ;((!s || s[l.getUTCDay()]) &&
      (e ? (d = r.add(l, e)) : (d = l), a.push(r.createMarker(n.toDate(d)))),
      (l = P(l, 1)))
  }
  return a
}
...
const vd = [
  ...
  X({
    name: 'misc',
    isLoadingFuncs: [t => us(t.eventSources)],
    propSetHandlers: { dateProfile: pd, eventStore: md },
  }),
]
class bd {
  constructor(e, n) {
    ;((this.runTaskOption = e),
      ...
      (this.queue = []),
      (this.delayedRunner = new sn(this.drain.bind(this))))
  }
  request(e, n) {
...
function yd(t, e, n) {
  ...
  return (
    /^(year|month)$/.test(t.currentRangeUnit)
      ? (r = t.currentRange)
      : (r = t.activeRange),
    n.formatRange(r.start, r.end, N(e.titleFormat || Ed(t)), {
      ...
      (typeof n == 'function'
        ...
        : r ||
          ((this.nowAnchorDate = e.toDate(
            n ? e.createMarker(n) : e.createNowMarker()
          )),
...
class Sd {
  constructor(e) {
    ;((this.computeCurrentViewData = A(this._computeCurrentViewData)),
      (this.organizeRawLocales = A(Dc)),
      (this.buildLocale = A(cs)),
      (this.buildPluginHooks = _c()),
      (this.buildDateEnv = A(Ad)),
      (this.buildTheme = A(Dd)),
      (this.parseToolbars = A(Kc)),
      (this.buildViewSpecs = A(Nc)),
      (this.buildDateProfileGenerator = Ye(wd)),
      (this.buildViewApi = A(Cd)),
      (this.buildViewUiProps = Ye(Td)),
      (this.buildEventUiBySource = A(Rd, W)),
      (this.buildEventUiBases = A(_d)),
      (this.parseContextBusinessHours = Ye(xd)),
      (this.buildTitle = A(yd)),
      (this.nowManager = new Ir()),
      (this.emitter = new bt()),
      (this.actionRunner = new bd(
    ...
    let l = {
      ...
      o = Lc(r.calendarOptions, r.dateEnv, this.nowManager),
      a = s.dateProfileGenerator.build(o)
    Y(a.activeRange, o) || (o = a.currentRange.start)
    for (let f of r.pluginHooks.contextInit) f(l)
    let d = zc(r.calendarOptions, a, l),
      c = {
    ...
    ;(Ht(c, l) && this.emitter.trigger('loading', !0),
      (this.state = c),
      this.updateData(),
  ...
  _handleAction(e) {
    ...
    ;(this.data &&
      ...
      (c = Bc(c, e)),
      (h = jc(h, e, c, a.dateProfileGenerator)),
      (e.type === 'PREV' || e.type === 'NEXT' || !Y(h.currentRange, c)) &&
        (c = h.currentRange.start))
    let f = Fc(r.eventSources, e, h, d),
      u = zo(r.eventStore, e, f, h, d),
      v =
        (us(f) &&
          !a.options.progressiveEventRendering &&
          r.renderableEventStore) ||
        u,
      { eventUiSingleBase: b, selectionConfig: y } = this.buildViewUiProps(d),
      E = this.buildEventUiBySource(f),
      D = this.buildEventUiBases(v.defs, b, E),
      w = {
        ...
        eventSelection: $c(r.eventSelection, e),
        eventDrag: Xc(r.eventDrag, e),
        eventResize: Jc(r.eventResize, e),
      },
      O = Object.assign(Object.assign({}, d), w)
    for (let R of l.pluginHooks.reducers) Object.assign(w, R(r, e, O))
    let T = Ht(r, d),
      I = Ht(w, d)
    ;(!T && I ? i.trigger('loading', !0) : T && !I && i.trigger('loading', !1),
      (this.state = w),
  ...
  updateData() {
    ...
    if (a && a !== d) {
      a.timeZone !== d.timeZone &&
        ((n.eventSources = l.eventSources =
          Wc(l.eventSources, n.dateProfile, l)),
        (n.eventStore = l.eventStore = Er(l.eventStore, r.dateEnv, l.dateEnv)),
        (n.renderableEventStore = l.renderableEventStore =
          Er(l.renderableEventStore, r.dateEnv, l.dateEnv)))
      for (let c in o)
  ...
  processRawCalendarOptions(e, n) {
    ...
    for (let b in h)
      ...
      (h[b] === u[b] || (oe[b] && b in u && oe[b](u[b], h[b])))
        ? (f[b] = m[b])
        : d[b]
          ? ((f[b] = d[b](h[b])), (v = !0))
          : (c[b] = u[b])
  ...
  _computeCurrentViewData(e, n, r, i) {
    ...
    ;(kr(o), this.nowManager.handleInput(n.dateEnv, l.now))
  ...
  processRawViewOptions(e, n, r, i, s) {
    let l = _t([Ie, e.optionDefaults, r, i, e.optionOverrides, s]),
      o = Object.assign(
        Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign({}, gr), pr), mr),
      ...
      f = {}
    for (let u in l)
      l[u] === d[u] || (oe[u] && oe[u](l[u], d[u]))
        ? (a[u] = c[u])
        : (l[u] === this.currentCalendarOptionsInput[u] ||
          (oe[u] && oe[u](l[u], this.currentCalendarOptionsInput[u]))
...
function Ad(t, e, n, r, i, s, l, o) {
  let a = cs(e || l.defaultCode, l.map)
  return new mo({
...
function wd(t) {
  let e = t.dateProfileGeneratorClass || Si
  return new e(t)
}
function Cd(t, e, n) {
  return new td(t, e, n)
...
function xd(t) {
  return $o(t.options.businessHours, t)
}
function kr(t, e) {
  ...
  renderWidgetGroup(e) {
    ...
    for (let l of e) {
      ...
      if (o === 'title')
        ((s = !1),
          i.push(
            g('h2', { className: 'fc-toolbar-title', id: n.titleId }, n.title)
          ))
      else {
...
class kd extends Ce {
  constructor(e) {
    ;(super(e),
      (this.handleSegClick = (n, r) => {
        ...
        if (l && i.isValidSegDownEl(n.target)) {
          ...
          ;(s.emitter.trigger('eventClick', {
            el: r,
            event: new k(i.context, l.eventRange.def, l.eventRange.instance),
            jsEvent: n,
            view: s.viewApi,
          }),
      ...
      (this.destroy = ci(e.el, 'click', '.fc-event', this.handleSegClick)))
  }
}
class Nd extends Ce {
  constructor(e) {
  ...
  triggerEvent(e, n, r) {
    ...
    ;(!n || i.isValidSegDownEl(n.target)) &&
      s.emitter.trigger(e, {
        el: r,
        event: new k(s, l.eventRange.def, l.eventRange.instance),
        jsEvent: n,
        view: s.viewApi,
      })
  }
...
class Od extends me {
  constructor() {
    ;(super(...arguments),
      (this.buildViewContext = A(yo)),
      (this.buildViewPropTransformers = A(Hd)),
      (this.buildToolbarProps = A(Pd)),
      (this.headerRef = B()),
      (this.footerRef = B()),
      (this.interactionsStore = {}),
      (this.state = { viewLabelId: gt() }),
      (this.registerInteractiveComponent = (e, n) => {
        let r = ba(e, n),
          l = [kd, Nd]
            .concat(this.props.pluginHooks.componentInteractions)
            .map(o => new o(r))
        ;((this.interactionsStore[e.uid] = l), (Zt[e.uid] = r))
      }),
...
class Bd extends Ea {
  constructor(e, n = {}) {
    ;(super(),
              ...
              g(
                ...
                (i, s, l, o) => (
                  ...
                  g(
                    ...
                    g(Od, Object.assign({ isHeightAuto: l, forPrint: o }, r))
                  )
                )
              ),
              this.el
      ...
      tl(e),
      (this.el = e),
      (this.renderRunner = new sn(this.handleRenderRequest)),
      new Sd({
        optionOverrides: n,
        calendarApi: this,
...
const Ld = parseInt(String(Ut.version).split('.')[0]),
  Ud = Ld < 18
class jd extends Lt.Component {
  constructor() {
    ;(super(...arguments),
      (this.elRef = Lt.createRef()),
      (this.isUpdating = !1),
      (this.isUnmounting = !1),
  ...
  render() {
    ...
    for (const n of this.state.customRenderingMap.values())
      e.push(Ut.createElement(zd, { key: n.id, customRendering: n }))
    return Ut.createElement('div', { ref: this.elRef }, e)
  }
  componentDidMount() {
    this.isUnmounting = !1
    const e = new Sc()
    ;((this.handleCustomRendering = e.handle.bind(e)),
      (this.calendar = new Bd(
        this.elRef.current,
    ...
    e.subscribe(r => {
      const i = Date.now(),
        s = !n
      ;(Ud || s || this.isUpdating || this.isUnmounting || i - n < 100
        ? ms
        : jt.flushSync)(() => {
...
jd.act = ms
class zd extends Lt.PureComponent {
  render() {
    const { customRendering: e } = this.props,
      { generatorMeta: n } = e,
      r = typeof n == 'function' ? n(e.renderProps) : n
    return jt.createPortal(r, e.containerEl)
  }
}
function ms(t) {
  t()
...
class Es extends _ {
  render() {
    let { props: e, context: n } = this,
      ...
      l = Oi(i, s, n, !0, e.defaultDisplayEventEnd)
    return g(
      In,
      Object.assign({}, e, {
        elTag: 'a',
...
class Vd extends _ {
  constructor() {
    ;(super(...arguments), (this.compileSegs = A(Gd)))
  }
  render() {
    let { props: e } = this,
...
const qd = N({ week: 'narrow' })
class Qd extends q {
  constructor() {
    ;(super(...arguments),
      (this.rootElRef = B()),
      (this.state = { dayNumberId: gt() }),
      (this.handleRootEl = e => {
  ...
  render() {
    ...
    const d = n.showDayNumber && Zd(o, a.currentRange, l)
    return g(
      On,
      {
        elTag: 'td',
      ...
      (c, h) =>
        g(
          ...
          !h.isDisabled && (n.showDayNumber || Pn(s) || n.forceDayTop)
            ? g(
                'div',
                ...
                g(c, {
                  ...
                  elAttrs: Object.assign(Object.assign({}, dt(e, o)), {
                    id: r.dayNumberId,
                  }),
                })
              )
...
function $d(t, e, n, r, i, s, l) {
  let o = new Kd(y => {
    let E =
      t[y.index].eventRange.instance.instanceId +
      ':' +
      y.span.start +
      ':' +
      (y.span.end - 1)
  ...
  ;((o.allowReslicing = !0),
    ...
    e === !0 || n === !0
      ...
      : typeof e == 'number'
        ? (o.maxStackCnt = e)
        : typeof n == 'number' &&
          ((o.maxStackCnt = n), (o.hiddenConsumes = !0)))
  let a = [],
    d = []
  for (let y = 0; y < t.length; y += 1) {
    let E = t[y],
      D = As(E)
    i[D] != null
      ? a.push({ index: y, span: { start: E.firstCol, end: E.lastCol + 1 } })
      : d.push(E)
  }
  let c = o.addSegs(a),
    h = o.toRects(),
  ...
  for (let y = 0; y < l.length; y += 1) v.push(0)
  for (let y of c) {
    let E = t[y.index],
      D = y.span
    u[D.start].push({
      seg: Se(E, D.start, D.end, l),
      isVisible: !1,
      isAbsolute: !0,
      absoluteTop: 0,
      marginTop: 0,
  ...
  for (let y = 0; y < l.length; y += 1) b.push(m[y])
  return {
    singleColPlacements: f,
    multiColPlacements: u,
    moreCnts: v,
...
function Se(t, e, n, r) {
  ...
  let i = t.eventRange,
    s = i.range,
    l = he(s, { start: r[e].date, end: P(r[n - 1].date, 1) })
  return Object.assign(Object.assign({}, t), {
    firstCol: e,
    lastCol: n - 1,
    eventRange: {
...
class Ds extends q {
  ...
  render() {
    let { props: e, state: n, context: r } = this,
      { options: i } = r,
      s = e.cells.length,
      l = Ve(e.businessHourSegs, s),
      o = Ve(e.bgEventSegs, s),
      a = Ve(this.getHighlightSegs(), s),
      d = Ve(this.getMirrorSegs(), s),
      {
    ...
    return g(
      ...
      e.cells.map((v, b) => {
        let y = this.renderFgSegs(b, e.forPrint ? c[b] : h[b], e.todayRange, m),
          E = this.renderFgSegs(
            b,
            eu(d[b], h),
            e.todayRange,
        ...
        return g(Qd, {
          ...
          moreCnt: f[b],
          moreMarginTop: u[b],
          singlePlacements: c[b],
          fgContentElRef: this.fgElRefs.createRef(v.key),
          fgContent: g(x, null, g(x, null, y), g(x, null, E)),
          bgContent: g(
            x,
            null,
  ...
  renderFgSegs(e, n, r, i, s, l, o) {
    ...
    if (c)
      for (let m of n) {
        let { seg: v } = m,
          { instanceId: b } = v.eventRange.instance,
          y = m.isVisible && !i[b],
          E = m.isAbsolute,
          D = '',
          w = ''
        ;(E &&
          (a.isRtl
            ? ((w = 0), (D = c.lefts[v.lastCol] - c.lefts[v.firstCol]))
            : ((D = 0), (w = c.rights[v.firstCol] - c.rights[v.lastCol]))),
          u.push(
            g(
              'div',
              {
                ...
                key: Ss(v),
                ref: f ? null : this.segHarnessRefs.createRef(As(v)),
                style: {
                  visibility: y ? '' : 'hidden',
      ...
      for (let o of e) {
        ...
        l.push(
          g(
            ...
            n === 'bg-event'
              ? g(ns, Object.assign({ seg: o }, ne(o, i)))
              : rs(n)
          )
        )
      }
      ...
      if (e) {
        ...
        if (a.length) {
          ...
          ;(!r.framePositions || !r.framePositions.similarTo(c)) &&
            this.setState({ framePositions: new we(d, a, !0, !1) })
        }
      }
...
Ds.addStateEquality({ segHeights: W })
function eu(t, e) {
  if (!t.length) return []
  let n = tu(e)
  return t.map(r => ({
...
class nu extends q {
  constructor() {
    ;(super(...arguments),
      (this.splitBusinessHourSegs = A($e)),
      (this.splitBgEventSegs = A(ru)),
      (this.splitFgEventSegs = A($e)),
      (this.splitDateSelectionSegs = A($e)),
      (this.splitEventDrag = A(Or)),
      (this.splitEventResize = A(Or)),
      (this.rowRefs = new Q()))
  }
  render() {
    let { props: e, context: n } = this,
      ...
      c =
        r >= 7 && e.clientWidth
          ? e.clientWidth / n.options.aspectRatio / 6
          : null
    return g(Re, { unit: 'day' }, (h, f) =>
      g(
        x,
        null,
        e.cells.map((u, m) =>
  ...
  prepareHits() {
    ;((this.rowPositions = new we(
      this.rootEl,
      this.rowRefs.collect().map(e => e.getCellEls()[0]),
      !1,
      !0
    )),
      (this.colPositions = new we(
        this.rootEl,
...
class su extends q {
  ...
  flushScrollReset() {
    if (this.needsScrollReset && this.props.clientWidth) {
      const e = lu(this.elRef.current, this.props.dateProfile)
      if (e) {
...
function lu(t, e) {
  ...
  return (
    e.currentRangeUnit.match(/year|month/) &&
      (n = t.querySelector(`[data-date="${zl(e.currentDate)}-01"]`)),
    n || (n = t.querySelector(`[data-date="${dn(e.currentDate)}"]`)),
    n
  )
}
class ou extends $i {
...
var Sf = X({
  ...
  views: {
    dayGrid: { component: au, dateProfileGeneratorClass: du },
...
class mu extends _ {
  render() {
    return this.props.slatMetas.map(e =>
      g('tr', { key: e.key }, g(Cs, Object.assign({}, e)))
    )
  }
}
const vu = N({ week: 'short' }),
  bu = 5
class yu extends q {
  constructor() {
    ;(super(...arguments),
      (this.allDaySplitter = new hu()),
      (this.headerElRef = B()),
      (this.rootElRef = B()),
      (this.scrollerElRef = B()),
      ...
      (this.renderHeadAxis = (e, n = '') => {
        let { options: r } = this.context,
          ...
          s = i.renderRange,
          o = se(s.start, s.end) === 1 ? dt(this.context, s.start, 'week') : {}
  ...
  renderHScrollLayout(e, n, r, i, s, l, o) {
    ...
    let { context: d, props: c } = this,
      h = !c.forPrint && ut(d.options),
      f = !c.forPrint && ts(d.options),
      u = []
    ;(e &&
      u.push({
        type: 'header',
            ...
            content: v =>
              g(
                ...
                g(
                  ...
                  v.tableColGroupNode,
                  g('tbody', null, g(mu, { slatMetas: l }))
                ),
                g(
                  'div',
                  { className: 'fc-timegrid-now-indicator-container' },
                  g(Re, { unit: m ? 'minute' : 'day' }, b => {
...
class Su {
  ...
  computeTimeTop(e) {
    let { positions: n, dateProfile: r } = this,
      i = n.els.length,
      s = (e.milliseconds - F(r.slotMinTime)) / F(this.slotDuration),
      l,
      o
    return (
      (s = Math.max(0, s)),
      ...
      n.onCoords(
        new Su(
          new we(
            ...
            wu(this.slatElRefs.currentMap, n.slatMetas),
            !1,
            !0
          ),
  ...
  render() {
    ...
    return g(
      ss,
      {
        ...
        dateProfile: e.dateProfile,
        todayRange: e.todayRange,
        popoverContent: () => _s(e.hiddenSegs, e),
        defaultGenerator: Ru,
        forceTimed: !0,
      },
      n =>
...
function _u(t, e, n) {
  ...
  let i = r.addSegs(t),
    s = La(i),
    l = Tu(r)
  return ((l = ku(l, 1)), { segRects: Nu(l), hiddenGroups: s })
}
function Tu(t) {
...
function Hr(t, e) {
  ...
  return (l.sort(xu), [l.map(Mu), l[0][1]])
}
function xu(t, e) {
  return e[1] - t[1]
}
...
function Iu(t, e, n) {
  ...
  for (; a < o; a += 1) {
    let d = i[a],
      c,
      h = Xt(d, s.span.start, $t),
      f = h[0] + h[1],
      u = f
    for (; (c = d[u]) && c.span.start < s.span.end; ) u += 1
    if (f < u) return { level: a, lateralStart: f, lateralEnd: u }
  }
  return null
}
function ku(t, e) {
...
class Hu extends _ {
  constructor() {
    ;(super(...arguments), (this.sortEventSegs = A(Ni)))
  }
  render() {
    let { props: e, context: n } = this,
      { options: r } = n,
    ...
    return g(
      ...
      a =>
        g(
          ...
          Pn(r) && g(a, { elTag: 'div', elClasses: ['fc-timegrid-col-misc'] })
        )
    )
  }
  ...
  renderPositionedFgSegs(e, n, r, i, s, l) {
    let {
      ...
      b = r || i || s,
      y = Br(e, h, f, c),
      { segPlacements: E, hiddenGroups: D } = Ou(e, y, d, o)
    return g(
      x,
      null,
      ...
      E.map(w => {
        let { seg: O, rect: T } = w,
          ...
          R = b || !!(!n[I] && T),
          J = Bt(T && T.span),
          _e = !b && T ? this.computeSegHStyle(T) : { left: 0, right: 0 },
        ...
        return g(
          'div',
          {
            ...
            key: l || I,
            style: Object.assign(
              Object.assign({ visibility: R ? '' : 'hidden' }, J),
              _e
            ),
          },
          g(
  ...
  renderFillSegs(e, n) {
    let { props: r, context: i } = this,
      l = Br(e, r.date, r.slatCoords, i.options.eventMinHeight).map((o, a) => {
        let d = e[a]
        return g(
          'div',
          {
          ...
          n === 'bg-event'
            ? g(ns, Object.assign({ seg: d }, ne(d, r.todayRange, r.nowDate)))
            : rs(n)
        )
      })
    return g(x, null, l)
  ...
  computeSegHStyle(e) {
    ...
    return (
      i && !e.stackForward && (d[n ? 'marginLeft' : 'marginRight'] = 10 * 2),
      d
    )
  }
}
...
class Lu extends _ {
  constructor() {
    ;(super(...arguments),
      (this.splitFgEventSegs = A(Te)),
      (this.splitBgEventSegs = A(Te)),
      (this.splitBusinessHourSegs = A(Te)),
      (this.splitNowIndicatorSegs = A(Te)),
      (this.splitDateSelectionSegs = A(Te)),
      (this.splitEventDrag = A(Pr)),
      (this.splitEventResize = A(Pr)),
      (this.rootElRef = B()),
      (this.cellElRefs = new Q()))
  }
  render() {
        ...
        g(
          ...
          g(
            ...
            e.cells.map((f, u) =>
              g(Hu, {
                key: f.key,
                elRef: this.cellElRefs.createRef(f.key),
                dateProfile: e.dateProfile,
                date: f.date,
                nowDate: e.nowDate,
                todayRange: e.todayRange,
                extraRenderProps: f.extraRenderProps,
                extraDataAttrs: f.extraDataAttrs,
                extraClassNames: f.extraClassNames,
                extraDateSpan: f.extraDateSpan,
                fgEventSegs: s[u],
                bgEventSegs: l[u],
  ...
  updateCoords() {
    ...
    e.onColCoords &&
      ...
      e.onColCoords(
        new we(
          this.rootElRef.current,
          Uu(this.cellElRefs.currentMap, e.cells),
          !0,
          !1
        )
      )
...
class ju extends q {
  ...
  queryHit(e, n) {
    let { dateEnv: r, options: i } = this.context,
      ...
      c = s.leftToIndex(e),
      h = o.positions.topToIndex(n)
    if (c != null && h != null) {
      let f = this.props.cells[c],
        u = o.positions.tops[h],
        m = o.positions.getHeight(h),
        v = (n - u) / m,
        b = Math.floor(v * d),
        y = h * d + b,
        E = this.props.cells[c].date,
        D = Vt(l.slotMinTime, Rl(a, y)),
        w = r.add(E, D),
        O = r.add(w, a)
      return {
        dateProfile: l,
        dateSpan: Object.assign(
          { range: { start: w, end: O }, allDay: !1 },
          f.extraDateSpan
        ),
        dayEl: s.els[c],
...
class Wu extends q {
  ...
  render() {
    ...
    return g(Re, { unit: s ? 'minute' : 'day' }, (a, d) =>
      g(
        ju,
        Object.assign(
...
function qu(t) {
  let e, n, r
  for (e = Lr.length - 1; e >= 0; e -= 1)
    if (((n = C(Lr[e])), (r = cn(n, t)), r !== null && r > 1)) return n
  return t
}
class Qu extends yu {
  constructor() {
    ;(super(...arguments),
      (this.buildTimeColsModel = A(Yu)),
      (this.buildSlatMetas = A(Gu)))
  }
  render() {
    ...
    return h
      ? this.renderHScrollLayout(f, u, m, l.colCnt, d, a, this.state.slatCoords)
      : this.renderSimpleLayout(f, u, m)
  }
}
function Yu(t, e) {
  let n = new Yi(t.renderRange, e)
...
class Ts {
  constructor(e) {
    ;((this.subjectEl = null),
      ...
      (this.handleMouseDown = n => {
        if (!this.shouldIgnoreMouse() && Xu(n) && this.tryStart(n)) {
  ...
  shouldIgnoreMouse() {
    return en || this.isTouchDragging
  }
  cancelTouchScroll() {
    this.isDragging && (tn = !0)
  }
  initScrollWatch(e) {
...
function Ku() {
  ;((ft += 1),
    ft === 1 && window.addEventListener('touchmove', xs, { passive: !1 }))
}
function ef() {
  ;((ft -= 1),
    ft || window.removeEventListener('touchmove', xs, { passive: !1 }))
}
function xs(t) {
  tn && t.preventDefault()
}
class tf {
  ...
  doRevertAnimation(e, n) {
    ...
    ;((r.style.transition = 'top ' + n + 'ms,left ' + n + 'ms'),
      xe(r, { left: i.left, top: i.top }),
      ul(r, () => {
        ;((r.style.transition = ''), e())
      }))
  }
  cleanup() {
    ;(this.mirrorEl && (ln(this.mirrorEl), (this.mirrorEl = null)),
      (this.sourceEl = null))
  }
  updateElPosition() {
    this.sourceEl &&
  ...
  handleMove(e, n) {
    if (this.isEnabled) {
      ...
      ;(s < 0 ? (this.everMovedUp = !0) : s > 0 && (this.everMovedDown = !0),
        ...
        this.isAnimating ||
          ((this.isAnimating = !0), this.requestAnimation(Ur())))
    }
  }
  stop() {
    if (this.isEnabled) {
        ...
        if (this.isInteracting) {
          if (
            ...
            let s = this.minDistance,
              ...
              { deltaX: o, deltaY: a } = i
            ;((l = o * o + a * a),
              l >= s * s && this.handleDistanceSurpassed(i))
          }
          this.isDragging &&
...
class sf {
  constructor(e) {
    ;((this.el = e),
      (this.origRect = Rn(e)),
      (this.scrollCaches = Wi(e).map(n => new Is(n, !0))))
  }
  destroy() {
    for (let e of this.scrollCaches) e.destroy()
  }
  ...
  isWithinClipping(e, n) {
    ...
    for (let i of this.scrollCaches)
      if (!lf(i.getEventTarget()) && !Sa(r, i.clientRect)) return !1
    return !0
  }
}
function lf(t) {
...
class yt {
  ...
  processFirstCoord(e) {
    let n = { left: e.pageX, top: e.pageY },
      ...
      i = e.subjectEl,
      s
    i instanceof HTMLElement && ((s = Rn(i)), (r = Aa(r, s)))
  ...
  handleMove(e, n) {
    ...
    ;(n || !Et(this.movingHit, r)) &&
      ((this.movingHit = r), this.emitter.trigger('hitupdate', r, !1, e))
  }
  prepareHits() {
    this.offsetTrackers = Z(
      this.droppableStore,
      e => (e.component.prepareHits(), new sf(e.el))
    )
  }
  releaseHits() {
    ...
    for (let l in r) {
      ...
      if (a && a.isWithinClipping(e, n)) {
        ...
        if (h >= 0 && h < m && f >= 0 && f < v) {
          ...
          b &&
            mt(b.dateProfile.activeRange, b.dateSpan.range) &&
...
function Et(t, e) {
  return !t && !e ? !0 : !!t != !!e ? !1 : da(t.dateSpan, e.dateSpan)
}
function ks(t, e) {
  let n = {}
  for (let r of e.pluginHooks.datePointTransforms) Object.assign(n, r(t, e))
  return (Object.assign(n, of(t, e.dateEnv)), n)
}
function of(t, e) {
  return {
    ...
    ;(super(e),
      ...
      (this.handleDragEnd = r => {
        ...
        if (!s.wasTouchScroll) {
          ...
          if (l && o && Et(l, o)) {
            let { context: a } = i,
              d = Object.assign(Object.assign({}, ks(l.dateSpan, a)), {
                dayEl: l.dayEl,
                jsEvent: r.origEvent,
      ...
      (this.dragging = new He(e.el)),
      (this.dragging.autoScroller.isEnabled = !1))
    let n = (this.hitDragging = new yt(this.dragging, wn(e)))
  ...
  constructor(e) {
    ;(super(e),
      ...
      (this.handlePointerDown = l => {
        ...
        ;(a.setIgnoreMove(!c), (a.delay = l.isTouch ? df(o) : null))
      }),
      ...
      (this.handleHitUpdate = (l, o) => {
        ...
        if (l) {
          ...
          ;((l.componentId === h.componentId &&
            ...
            (d = uf(h, l, a.pluginHooks.dateSelectionTransformers)),
      ...
      (this.handlePointerUp = l => {
        this.dragSelection &&
          (Mi(this.dragSelection, l, this.component.context),
          (this.dragSelection = null))
      }))
    let { component: n } = e,
      { options: r } = n.context,
      i = (this.dragging = new He(e.el))
    ;((i.touchScrollAllowed = !1),
      (i.minDistance = r.selectMinDistance || 0),
      (i.autoScroller.isEnabled = r.dragScroll))
    let s = (this.hitDragging = new yt(this.dragging, wn(e)))
  ...
  constructor(e) {
    ;(super(e),
      ...
      (this.handlePointerDown = l => {
        ...
        let u = (this.subjectSeg = De(l.subjectEl)),
          v = (this.eventRange = u.eventRange).instance.instanceId
        ;((this.relevantEvents = En(f.getCurrentData().eventStore, v)),
          (d.minDistance = l.isTouch ? 0 : h.eventDragMinDistance),
          (d.delay = l.isTouch && v !== a.props.eventSelection ? hf(a) : null),
          h.fixedMirrorParent
            ? (c.parentNode = h.fixedMirrorParent)
            : (c.parentNode = H(o, '.fc')),
          (c.revertDuration = h.dragRevertDuration))
        let b = a.isValidSegDownEl(o) && !H(o, '.fc-event-resizer')
        ;(d.setIgnoreMove(!b),
          (this.isDragging =
            b && l.subjectEl.classList.contains('fc-event-draggable')))
      }),
      (this.handleDragStart = l => {
        ...
        ;(l.isTouch
          ...
          this.isDragging &&
            ...
            o.emitter.trigger('eventDragStart', {
              el: this.subjectEl,
              event: new k(o, a.def, a.instance),
              jsEvent: l.origEvent,
              view: o.viewApi,
            })))
      }),
      (this.handleHitUpdate = (l, o) => {
        ...
        let a = this.relevantEvents,
          ...
          u = null,
          m = !1,
          v = { affectedEvents: a, mutatedEvents: j(), isEvent: !0 }
        if (l) {
          h = l.context
          let b = h.options
          c === h || (b.editable && b.droppable)
            ? ((f = ff(
                d,
                l,
              ...
              f &&
                ((u = Dn(a, h.getCurrentData().eventUiBases, f, h)),
                (v.mutatedEvents = u),
                Xi(v, l.dateProfile, h) ||
                  ((m = !0), (f = null), (u = null), (v.mutatedEvents = j()))))
            : (h = null)
        }
          ...
          if (
            ...
            if (d === o) {
              ...
              let E = {
                  oldEvent: u,
                  event: y,
                  relatedEvents: de(v, o, f),
                  revert() {
                    o.dispatch({ type: 'MERGE_EVENTS', eventStore: m })
                  },
                },
                D = {}
              for (let w of o.getCurrentData().pluginHooks
                .eventDropTransformers)
              ...
              let E = v.defs[h.defId],
                D = v.instances[f.instanceId],
                w = new k(d, E, D)
              d.dispatch({ type: 'MERGE_EVENTS', eventStore: v })
              let O = {
                event: w,
                relatedEvents: de(v, d, D),
                revert() {
              ...
              ;(d.emitter.trigger('eventAdd', O),
                ...
                d.emitter.trigger(
                  'drop',
                  Object.assign(Object.assign({}, ks(b.dateSpan, d)), {
                    draggedEl: l.subjectEl,
                    jsEvent: l.origEvent,
    ...
    let { component: n } = this,
      { options: r } = n.context,
      i = (this.dragging = new He(e.el))
    ;((i.pointer.selector = Be.SELECTOR),
      (i.touchScrollAllowed = !1),
      (i.autoScroller.isEnabled = r.dragScroll))
    let s = (this.hitDragging = new yt(this.dragging, Zt))
...
Be.SELECTOR = '.fc-event-draggable, .fc-event-resizable'
function ff(t, e, n, r) {
  let i = t.dateSpan,
    s = e.dateSpan,
    l = i.range.start,
    ...
    ;(super(e),
      ...
      (this.handleHitUpdate = (s, l, o) => {
        let { context: a } = this.component,
          ...
          u = null,
          m = !1,
          v = { affectedEvents: d, mutatedEvents: j(), isEvent: !0 }
        ;(s &&
          ...
          f &&
            ((u = Dn(d, a.getCurrentData().eventUiBases, f, a)),
            (v.mutatedEvents = u),
            Xi(v, s.dateProfile, a) ||
              ((m = !0), (f = null), (u = null), (v.mutatedEvents = null))),
          u
        ...
        if (
          ...
          ;(l.emitter.trigger(
            ...
            Object.assign(Object.assign({}, u), {
              el: this.draggingSegEl,
              startDelta: this.validMutation.startDelta || C(0),
              endDelta: this.validMutation.endDelta || C(0),
              jsEvent: s.origEvent,
              view: l.viewApi,
            })
          ),
    ...
    ;((this.context = e),
      ...
      (this.onDocumentPointerDown = r => {
        let i = this.context.options.unselectCancel,
          s = ai(r.origEvent)
        ;((this.matchesCancel = !!H(s, i)),
          (this.matchesEvent = !!H(s, Be.SELECTOR)))
      }),
...
var Df = X({
  ...
  componentInteractions: [af, cf, Be, gf],
  calendarInteractions: [mf],
  elementDraggingImpl: He,
  optionRefiners: vf,
  listenerRefiners: bf,
})
export {
