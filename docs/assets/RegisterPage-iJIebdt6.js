...
import { c as r } from './auth-vendor-CMFeYHy6.js'
...
const l = () => {
  ...
  return e.jsx('div', {
    className:
      'min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 via-white to-blue-50 py-12 px-4 sm:px-6 lg:px-8',
    children: e.jsxs('div', {
      ...
      children: [
        e.jsxs('div', {
          ...
          children: [
            ...
            e.jsx('h2', {
              ...
              children: 'Registrati al Sistema',
            }),
            e.jsx('p', {
              className: 'text-sm text-gray-600 leading-relaxed',
              children:
                'Inizia a gestire la sicurezza alimentare del tuo ristorante con strumenti professionali',
            }),
          ],
        }),
        e.jsx('div', {
        ...
        e.jsx('div', {
          ...
          children: e.jsxs('button', {
            onClick: () => t('/'),
            className:
              'text-gray-600 hover:text-green-600 text-sm font-medium transition-colors duration-200 flex items-center justify-center gap-2',
            children: [
              e.jsx('svg', {
                className: 'w-4 h-4',
                fill: 'none',
